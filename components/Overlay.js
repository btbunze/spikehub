    ...
    render() {
        ...
        switch (this.props.type){
            ...
            case "defaultPlayer":
                overlayRender = (
                    <>
                        <h2 className = "form-title">Use Info From Your Profile?</h2>
                        <p className = "profile-error-message hidden">Make sure your profile has a name and contact info and try again</p>
                        ...
                        <div style = {{display:"flex", justifyContent: "space-between", marginTop: "20px"}}>
                            <button className = "add-player-button" onClick = {this.props.onClick}>No</button>
                            <button className = "add-player-button" onClick = {this.props.submit}>Yes</button>
                        </div>
                    </>
                )
                break;
            case "addPastTournament":
                overlayRender = (
                    <>
                        <h2 className = "form-title">Add Tournament</h2>
                        <label>Tournament Name</label>
                        <input className = "form-input add-player-input"></input>
                        <label>Partner</label>
                        <input className = "form-input add-player-input"></input>
                        ...
                        <div style = {{display:"flex", justifyContent: "space-between", marginTop: "20px"}}>
                            <button className = "add-player-button" onClick = {this.props.onClick}>Cancel</button>
                            <button className = "add-player-button" onClick = {this.props.submit}>Confirm</button>
                        </div>
                    </>
                )
                break;
