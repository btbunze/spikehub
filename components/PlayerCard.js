            ...
            <div className = "player-card" onClick = {this.props.onClick}>
                <div className = "pc-content ">
                    ...
                    {this.props.player.selfDesc ? 
                        <p className = "pc-desc">
                            {this.props.player.selfDesc.length >=75 ? (<> {this.props.player.selfDesc.substring(0,61)}...<button style = {{position:"relative", zIndex: "2"}}onClick = {this.toggleMore}>See More</button></>): (this.props.player.selfDesc.substring(0,75))} 
                            {/* change from toggle more to see profile when profile update launches
